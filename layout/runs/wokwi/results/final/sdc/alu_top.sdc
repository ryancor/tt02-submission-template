...
# Thu Nov 24 01:28:10 2022
###############################################################################
current_design alu_top
###############################################################################
# Timing Constraints
###############################################################################
create_clock -name io_in[0] -period 100000.0000 [get_ports {io_in[0]}]
...
set_input_delay 20000.0000 -clock [get_clocks {io_in[0]}] -add_delay [get_ports {io_in[1]}]
set_input_delay 20000.0000 -clock [get_clocks {io_in[0]}] -add_delay [get_ports {io_in[2]}]
set_input_delay 20000.0000 -clock [get_clocks {io_in[0]}] -add_delay [get_ports {io_in[3]}]
set_input_delay 20000.0000 -clock [get_clocks {io_in[0]}] -add_delay [get_ports {io_in[4]}]
set_input_delay 20000.0000 -clock [get_clocks {io_in[0]}] -add_delay [get_ports {io_in[5]}]
set_input_delay 20000.0000 -clock [get_clocks {io_in[0]}] -add_delay [get_ports {io_in[6]}]
set_input_delay 20000.0000 -clock [get_clocks {io_in[0]}] -add_delay [get_ports {io_in[7]}]
set_output_delay 20000.0000 -clock [get_clocks {io_in[0]}] -add_delay [get_ports {io_out[0]}]
set_output_delay 20000.0000 -clock [get_clocks {io_in[0]}] -add_delay [get_ports {io_out[1]}]
set_output_delay 20000.0000 -clock [get_clocks {io_in[0]}] -add_delay [get_ports {io_out[2]}]
set_output_delay 20000.0000 -clock [get_clocks {io_in[0]}] -add_delay [get_ports {io_out[3]}]
set_output_delay 20000.0000 -clock [get_clocks {io_in[0]}] -add_delay [get_ports {io_out[4]}]
set_output_delay 20000.0000 -clock [get_clocks {io_in[0]}] -add_delay [get_ports {io_out[5]}]
set_output_delay 20000.0000 -clock [get_clocks {io_in[0]}] -add_delay [get_ports {io_out[6]}]
set_output_delay 20000.0000 -clock [get_clocks {io_in[0]}] -add_delay [get_ports {io_out[7]}]
###############################################################################
# Environment
###############################################################################
